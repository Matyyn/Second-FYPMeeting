...
const SliderScreen = ({ navigation, route }) => {
  ...
  const handleForward = async () => {
    ...
    // console.log("Selected Stress Title:", stressTimeline);
    // console.log("Previous Screen Params:", specificEmotion,emotion,reasonOfEmotion,elaborationText,date );
    // // Handle forward logic
    
    clientId= "646a465d4febe2829a96b83c"
    var result ;
    const values = {
      checkinDate:date,
    ...
    result =await axios.post('/psychologicalProfile',values)
    console.log(result)
  };
