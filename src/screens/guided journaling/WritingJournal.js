 ...
 // const [allInputsFilled, setAllInputsFilled] = useState(false);
  ...
  const handleComplete =async () => {
    ...
    if (filled) {
      ...
      await axios.post('/openJournal',journalEntry)
      navigation.navigate('completeJournal'); 
      }
      else if(journalType ==='reflectionJournal'){
        await axios.post('/reflectionJournal',journalEntry)
        navigation.navigate('completeJournal'); 
      }
      else if(journalType === 'gratitudeJournal'){
        await axios.post('/gratitudeJournal',journalEntry)
        navigation.navigate('completeJournal'); 
      }
      else if(journalType === 'problemsolvingJournal'){
        await axios.post('/problemsolvingJournal',journalEntry)
        navigation.navigate('completeJournal'); 
      }
